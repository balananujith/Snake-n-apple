...
**Features:**
  ...
  6) **Level Adjustment:** The game also has a buttons which could could adjust the speed of the game according to the       
                           levels like for beginner it would be slow, & for intermediate it would be fast but not that much
                          fast compared to advanced, & for advanced it would be fastest  
